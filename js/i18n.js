...
const DICT = {
  zh: {
    ...
    btn_settings: "设置",
    btn_tutorial: "再看教程",
    menu_foot: "割草向肉鸽 · 存档防篡改 · 内网联机（外网接口已预留）",
    settings_title: "设置",
    settings_lang: "语言",
    settings_master: "主音量",
    settings_sfx: "音效音量",
    ...
    pause_title: "暂停",
    hint: "WASD 移动 · 鼠标瞄准 · 左键普攻 · 右键/Shift 折冲 · 空格 大招 · Esc 暂停",
    toast_saved: "设置已保存",
    hp_label: "折光",
    mp_label: "墨能",
  },
  en: {
    ...
    menu_foot: "Horde roguelite · signed saves · LAN co-op (WAN reserved)",
    ...
    pause_title: "Paused",
    hint: "WASD move · Mouse aim · LMB shoot · RMB/Shift dash · Space ult · Esc pause",
