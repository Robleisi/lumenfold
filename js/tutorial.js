...
const STEPS = [
  ...
  },
  {
    id: "move",
    title: "移动：WASD",
    body: "用 WASD（或方向键）在纸页上滑行。先随便走几步。",
    spot: "hint",
    wait: "move",
  },
  {
    id: "aim",
    title: "瞄准与普攻",
    body: "鼠标决定折刃方向，按住左键连射。清掉这波纸屑螨试试手感。",
    spot: "hint",
    wait: "shoot",
  },
  {
    id: "dash",
    title: "折冲",
    body: "右键或 Shift 向前撕开一道光带——既能躲弹，也能割伤路过的敌人。",
    spot: "hint",
    wait: "dash",
  },
  {
    id: "ult",
    title: "大招 · 墨能",
    body: "空格释放大招，消耗右侧墨能。群怪堆在一起时甩一下最爽。",
    spot: "mp",
    wait: "ult",
  },
  {
  ...
  },
  {
    id: "meta",
    title: "越玩越多",
    body: "死后或通关获得折光尘，可在「织造工坊」永久解锁新敌、新层、新共鸣。准备好了就开始真正的织界。",
    spot: null,
    wait: "click",
  },
];
